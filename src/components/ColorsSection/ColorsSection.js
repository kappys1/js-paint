...
class ColorsSection extends Component {
  /**
   * Creates an instance of ColorsSection
  ...
  constructor({codes, defaultCode, onColorClick}) {
    ...
    this.element.classList.add('ColorsSection')
    ...
    this.codes.forEach((code, index) => {
      ...
      if (index % nthBreakElement === 0 && index !== 0) {
